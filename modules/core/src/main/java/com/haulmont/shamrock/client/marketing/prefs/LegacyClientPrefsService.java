...
import com.haulmont.shamrock.client.marketing.prefs.storage.ShamrockClientPrefsRepository;
...
public class LegacyClientPrefsService {
    ...
    private static final Map<String, Function<ShamrockClientPrefs, Boolean>> CHANNELS = Map.of(
    ...
    public List<ChannelOptIn> getPreferences(com.haulmont.shamrock.client.marketing.prefs.model.ClientId id) {
        ClientId clientId = ClientPrefsUtils.convert(id);

        ShamrockClientPrefs preferences = clientPrefsRepository.getPreferencesAsXml(clientId);
    ...
    private List<ChannelOptIn> createChannelOptIns(ShamrockClientPrefs preferences) {
    ...
    private ShamrockClientPrefs spreadXmlPreferences(com.haulmont.shamrock.client.marketing.prefs.model.ClientId id, ShamrockClientPrefs preferences) {
        if (id == null) {
            return null;
        }
        ...
        if (preferences == null) {
            preferences = new ShamrockClientPrefs();
        }
